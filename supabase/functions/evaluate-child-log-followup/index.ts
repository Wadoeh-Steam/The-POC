...
import {
  buildChildFollowupEvaluationPrompt,
...
Deno.serve(async (req: Request) => {
  ...
  try {
    const prompt = buildChildFollowupEvaluationPrompt(body.question_text, body.answer_text, body.followup_number);
    ...
    console.error("evaluate-child-log-followup: generation failed, using fallback question:", err);
    return jsonResponse({
